...
pub mod tests {
    ...
    async fn can_access_deno_apis() -> anyhow::Result<()> {
        ...
        [
          ...
          "Deno.core.createSystemInterval()",
          "Deno.core.createSystemTimer()",
          "Deno.core.createTimer()",
          "Deno.core.currentUserCallSite()",
          "Deno.core.decode()",
          "Deno.core.defineGlobalProperties()",
          "Deno.core.deserialize()",
          "Deno.core.destructureError()",
          "Deno.core.encode()",
          "Deno.core.encodeBinaryString()",
          "Deno.core.errorConstructors.BadResource()",
          "Deno.core.errorConstructors.Error()",
          "Deno.core.errorConstructors.Interrupted()",
          "Deno.core.errorConstructors.NotCapable()",
          "Deno.core.errorConstructors.RangeError()",
          "Deno.core.errorConstructors.ReferenceError()",
          "Deno.core.errorConstructors.SyntaxError()",
          "Deno.core.errorConstructors.TypeError()",
          "Deno.core.errorConstructors.URIError()",
          "Deno.core.evalContext()",
          "Deno.core.eventLoopHasMoreWork()",
          "Deno.core.getActiveImmediateCount()",
          ...
          "Deno.core.isWeakMap()",
          "Deno.core.isWeakSet()",
          "Deno.core.kNoAsyncContextRestore=symbol",
          ...
          "Deno.core.ops.op_import_sync_with_source()",
          ...
          "Deno.core.ops.op_set_captured_bootstrap()",
